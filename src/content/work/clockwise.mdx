...
![Clockwise, the Pomodoro timer designed to help you focus.](/static/work/clockwise/intro.png)
...
*This app was designed using Figma and developed using React Native with Expo. Try it out at [clockwise.bchen.dev](https://clockwise.bchen.dev).*
