...
description: 'A UI design and web development project for Techies Without Borders. Our goal is to enable practitioners in resource-constrained areas to improve patient care, by providing them with access to continuing medical education (CME) content. I led the redesign and re-implementation of our admin panel, which facilitates the distribution of medical content.'
date: '2023.07.14'
previewImage: '/static/work/cmes-admin-panel/1.png'
---

# Introduction

![CMES admin panel introduction slide.](/static/work/cmes-admin-panel/1.png)
